...
from common_func import token_store, backend, logout
from screens.Home import Home


class Global_active_power(Screen):
    ...
    def show_plot(self, plot_type):
        ...
        if plot_type == "daily":
            url = f"{backend}/api/generate_plot_daily_global_active_power"
        elif plot_type == "weekly":
            url = f"{backend}/api/generate_plot_weekly_global_active_power"
        elif plot_type == "monthly":
            url = f"{backend}/api/generate_plot_monthly_global_active_power"
        else:
